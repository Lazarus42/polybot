...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Inverse 90% strategy using actual opposite-side trade price after signal."
    )
    ...
    # Pass 1: find first >= threshold trade (signal), then first opposite trade after signal
    ...
    for mid, res in mid_to_resolution.items():
        ...
        # We buy the opposite side's actual trade price after signal
